        ...
        <section className="center-block">
          <article className="poll-data">
            <p className="eve-poll-intro">
              The American Election Eve Poll is conducted to give greater
              insight into Americans' deeper throughts, with a focus on
              Americans of Color
            </p>
            ...
            <div>
              <div className="stats-wrapper">
                ...
                <p className="stat-block">
                  <span className="percent-highlight">70%</span> support
                  reducing funding for law enforcement and investing more in
                  social services and programs proven to reduce violence
                </p>
              </div>
            </div>
          </article>
